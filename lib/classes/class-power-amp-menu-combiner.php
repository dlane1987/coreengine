...
/**
 * Power AMP Menu Combiner
 *
 * @since 3.0.0
 */
class Power_AMP_Menu_Combiner extends AMP_Base_Sanitizer {
	...
	protected function find_and_combine() {
		...
		foreach ( $this->menus_to_combine as $attribute ) {
			...
			for ( $index = 0; $index < $menu_items->childNodes->length; $index++ ) {
				...
				$menu_item->setAttribute( 'class', 'power-amp-combined ' . $menu_item->getAttribute( 'class' ) );
