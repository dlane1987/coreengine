...
class Power_Customizer {
	 ...
	 *
	 * The Power Theme Settings and Theme SEO settings are registered in lib/admin/customizer.php.
	 *
	 * @since 2.6.0
	 */
	public function init() {
		 ...
		 * the `$power_customizer` object to be used to create Customizer
		 * panels, sections, and controls.
		 *
		 * @since 2.6.0
		 *
		 * @param Power_Customizer $this Power_Customizer instance.
		 */
		do_action( 'power_customizer', $this );
