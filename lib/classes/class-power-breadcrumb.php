 ...
 * If you change a private property expect that change to break Power in the future.
 *
 * @since 1.5.0
 *
 * @package Power\Breadcrumbs
 */
class Power_Breadcrumb {
	...
	public function __construct() {
		...
		// Default arguments.
		$this->args = require POWER_CONFIG_DIR . '/breadcrumbs.php';
	...
	public function get_output( $args = [] ) {
		...
		/**
		 * Filter the Power breadcrumb arguments.
		 *
		 * @since 1.5.0
		 *
		 * @param array $args {
		 ...
		 * }
		 */
		$this->args = apply_filters( 'power_breadcrumb_args', wp_parse_args( $args, $this->args ) );
	...
	protected function build_crumbs() {
		 ...
		 */
		$crumbs = apply_filters( 'power_build_crumbs', $crumbs, $this->args );
	...
	protected function get_archive_crumb() {
		...
		/**
		 * Filter the Power archive breadcrumb.
		 *
		 * @since 1.5.0
		 *
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_archive_crumb', $crumb, $this->args );
	...
	protected function get_single_crumb() {
		...
		/**
		 * Filter the Power single breadcrumb.
		 *
		 * @since 1.5.0
		 *
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_single_crumb', $crumb, $this->args );
	...
	protected function get_home_crumb() {
		...
		/**
		 * Filter the Power home breadcrumb.
		 *
		 * @since 1.5.0
		 *
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_home_crumb', $crumb, $this->args );
	...
	protected function get_blog_crumb() {
		...
		/**
		 * Filter the Power blog posts breadcrumb.
		 *
		 * @since 1.5.0
		 *
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_blog_crumb', $crumb, $this->args );
	...
	protected function get_search_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_search_crumb', $crumb, $this->args );
	...
	protected function get_404_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_404_crumb', $crumb, $this->args );
	...
	protected function get_page_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_page_crumb', $crumb, $this->args );
	...
	protected function get_attachment_crumb() {
		...
		/**
		 * Filter the Power attachment breadcrumb.
		 *
		 * @since 2.5.0
		 *
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_attachment_crumb', $crumb, $this->args );
	...
	protected function get_cpt_crumb() {
		...
		/**
		 * Filter the Power CPT breadcrumb.
		 *
		 * @since 2.5.0
		 *
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_cpt_crumb', $crumb, $this->args );
	...
	protected function get_category_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_category_crumb', $crumb, $this->args );
	...
	protected function get_tag_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_tag_crumb', $crumb, $this->args );
	...
	protected function get_tax_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_tax_crumb', $crumb, $this->args );
	...
	protected function get_year_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_year_crumb', $crumb, $this->args );
	...
	protected function get_month_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_month_crumb', $crumb, $this->args );
	...
	protected function get_day_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_day_crumb', $crumb, $this->args );
	...
	protected function get_author_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_author_crumb', $crumb, $this->args );
	...
	protected function get_post_type_crumb() {
		 ...
		 * @param array  $args  Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		return apply_filters( 'power_post_type_crumb', $crumb, $this->args );
	...
	protected function get_breadcrumb_link( $url, $title, $content, $sep = '' ) {
		 ...
		 * @param array  $args    Arguments used to generate the breadcrumbs. Documented in Power_Breadcrumbs::get_output().
		 */
		$link = apply_filters( 'power_breadcrumb_link', $link, $url, $title, $content, $this->args );
