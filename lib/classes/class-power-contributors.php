...
/**
 * Repository class for managing contributors to Power.
 *
 * @since 2.5.0
 *
 * @package Power\Contributors
 */
class Power_Contributors {

	/**
	 * Cache for all the contributor details.
	 *
	 * @var Power_Contributor[]
	 */
	protected $people;

	/**
	 * Initialise Power_Contributors object.
	 *
	 ...
	 *
	 * @param array $people Data set of people who have contributed to Power.
	 */
	public function __construct( array $people ) {
		...
		foreach ( $people as $key => $person ) {
			...
			$all[ $key ] = new Power_Contributor( $person['name'], $person['url'], $person['avatar'], $person['role'] );
		}
	 ...
	 * @return Power_Contributor Person matching ID `$id`.
	 */
