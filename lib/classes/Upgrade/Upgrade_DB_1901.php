...
/**
 * Upgrade class. Called when `db_version` Power setting is below 1901.
 *
 * @since 3.1.0
 */
class Upgrade_DB_1901 implements Upgrade_DB_Interface {
	...
	public function upgrade() {
		...
		if ( isset( $menu_locations['primary'] ) && $menu_locations['primary'] && ! power_get_option( 'nav' ) ) {
			$menu_locations['primary'] = 0;
			set_theme_mod( 'nav_menu_locations', $menu_locations );
		}

		// Clear assigned subnav if subnav disabled.
		if ( isset( $menu_locations['secondary'] ) && $menu_locations['secondary'] && ! power_get_option( 'subnav' ) ) {
