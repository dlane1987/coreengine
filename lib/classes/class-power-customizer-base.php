...
/**
 * Base class for Customizer classes in Power.
 *
 * No longer used by Power core, this class will eventually be deprecated.
 *
 * @since 2.1.0
 */
abstract class Power_Customizer_Base {
	...
	public function __construct() {
		...
		if ( method_exists( $this, 'register' ) ) {
			...
			_doing_it_wrong( 'Power_Customizer_Base', esc_html__( 'When extending Power_Customizer_Base, you must create a register method.', 'power' ), '2.1.0' );
		}
