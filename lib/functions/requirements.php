 ...
 */
function power_check_requirements() {
 ...
 */
function power_activate_fallback_theme( $stylesheet, WP_Theme $old_theme ) {

	unset( $_GET['activated'] ); // phpcs:ignore WordPress.Security.NonceVerification.Recommended

	if ( $old_theme->exists() && strpos( $old_theme->get_stylesheet(), 'power' ) === false ) {
