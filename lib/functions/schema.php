 ...
 *
 * @package Power\Schema
 * @author  CoreEngine
 * @license GPL-2.0-or-later
 * @link    www.daniellane.eu
 */

namespace CoreEngine\Power\Functions\Schema;

add_filter( 'power_attr_head', __NAMESPACE__ . '\\head' );
add_filter( 'power_attr_body', __NAMESPACE__ . '\\body' );
add_filter( 'power_attr_site-header', __NAMESPACE__ . '\\site_header' );
add_filter( 'power_attr_site-title', __NAMESPACE__ . '\\site_title' );
add_filter( 'power_attr_site-description', __NAMESPACE__ . '\\site_description' );
add_filter( 'power_attr_breadcrumb', __NAMESPACE__ . '\\breadcrumb' );
add_filter( 'power_attr_breadcrumb-link-wrap', __NAMESPACE__ . '\\breadcrumb_link_wrap' );
add_filter( 'power_attr_breadcrumb-link-wrap-meta', __NAMESPACE__ . '\\breadcrumb_link_wrap_meta' );
add_filter( 'power_attr_breadcrumb-link', __NAMESPACE__ . '\\breadcrumb_link', 10, 3 );
add_filter( 'power_attr_breadcrumb-link-text-wrap', __NAMESPACE__ . '\\breadcrumb_link_text_wrap' );
add_filter( 'power_attr_search-form', __NAMESPACE__ . '\\search_form' );
add_filter( 'power_attr_search-form-meta', __NAMESPACE__ . '\\search_form_meta' );
add_filter( 'power_attr_search-form-input', __NAMESPACE__ . '\\search_form_input', 10, 3 );
add_filter( 'power_attr_nav-primary', __NAMESPACE__ . '\\nav_primary' );
add_filter( 'power_attr_nav-secondary', __NAMESPACE__ . '\\nav_secondary' );
add_filter( 'power_attr_nav-header', __NAMESPACE__ . '\\nav_header' );
add_filter( 'power_attr_nav-link-wrap', __NAMESPACE__ . '\\nav_link_wrap' );
add_filter( 'power_attr_nav-link', __NAMESPACE__ . '\\nav_link' );
add_filter( 'power_attr_entry', __NAMESPACE__ . '\\entry' );
add_filter( 'power_attr_entry-image', __NAMESPACE__ . '\\entry_image' );
add_filter( 'power_attr_singular-entry-image', __NAMESPACE__ . '\\singular_entry_image' );
add_filter( 'power_attr_entry-image-widget', __NAMESPACE__ . '\\entry_image_widget' );
add_filter( 'power_attr_entry-image-grid-loop', __NAMESPACE__ . '\\entry_image_grid_loop' );
add_filter( 'power_attr_entry-author', __NAMESPACE__ . '\\entry_author' );
add_filter( 'power_attr_entry-author-link', __NAMESPACE__ . '\\entry_author_link' );
add_filter( 'power_attr_entry-author-name', __NAMESPACE__ . '\\entry_author_name' );
add_filter( 'power_attr_entry-time', __NAMESPACE__ . '\\entry_time' );
add_filter( 'power_attr_entry-modified-time', __NAMESPACE__ . '\\entry_modified_time' );
add_filter( 'power_attr_entry-title', __NAMESPACE__ . '\\entry_title' );
add_filter( 'power_attr_entry-content', __NAMESPACE__ . '\\entry_content' );
add_filter( 'power_attr_comment', __NAMESPACE__ . '\\comment' );
add_filter( 'power_attr_comment-author', __NAMESPACE__ . '\\comment_author' );
add_filter( 'power_attr_comment-author-link', __NAMESPACE__ . '\\comment_author_link' );
add_filter( 'power_attr_comment-author-name', __NAMESPACE__ . '\\comment_author_name' );
add_filter( 'power_attr_comment-time', __NAMESPACE__ . '\\comment_time' );
add_filter( 'power_attr_comment-time-link', __NAMESPACE__ . '\\comment_time_link', 10, 3 );
add_filter( 'power_attr_comment-content', __NAMESPACE__ . '\\comment_content' );
add_filter( 'power_attr_author-box', __NAMESPACE__ . '\\author_box' );
add_filter( 'power_attr_sidebar-primary', __NAMESPACE__ . '\\sidebar_primary' );
add_filter( 'power_attr_sidebar-secondary', __NAMESPACE__ . '\\sidebar_secondary' );
add_filter( 'power_attr_site-footer', __NAMESPACE__ . '\\site_footer' );
