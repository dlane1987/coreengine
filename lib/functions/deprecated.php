 ...
 * @deprecated 3.1.0
 */
function power_upgrade_3001() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_3001::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_3001_page_blog() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_3001::migrate_blog_pages()' );

	( new Upgrade\Upgrade_DB_3001() )->migrate_blog_pages();
}

/**
 * Generate page_archive.php template file for blogs using default Power page_archive.php.
 *
 * @since 3.0.0
 *
 * @deprecated 3.1.0
 */
function power_upgrade_3001_page_archive() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_3001::migrate_archive_pages()' );
 ...
 */
function power_theme_has_page_blog_template() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_3001::blog_template_exists()' );
 ...
 */
function power_theme_has_page_archive_template() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_3001::archive_template_exists()' );
 ...
 */
function power_create_page_blog_file() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_3001::create_blog_template()' );
 ...
 * @return int|bool|void Void if file exists, number of bytes written, or false if error.
 */
function power_create_page_archive_file() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_3001::create_archive_template()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_3000() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_3000::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_2700() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_2700::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_2603() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_2603::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_2501() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_2501::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_2403() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_2403::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_2209() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_2209::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_2207() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_2207::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_2201() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_2201::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_2100() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_2100::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_2003() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_2003::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_2001() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_2001::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_1901() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_1901::upgrade()' );
 ...
 * @deprecated 3.1.0
 */
function power_upgrade_1800() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_1800::upgrade()' );
 ...
 */
function power_upgrade_1700() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_1700::upgrade()' );
 ...
 *
 * Called in `power_upgrade_1800()`.
 *
 * @since 2.6.0
 *
 * @deprecated 3.1.0
 */
function power_convert_term_meta() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_1800::convert_term_meta()' );
 ...
 *
 * Called in `power_upgrade_2603()`.
 *
 * @since 2.6.1
 *
 * @deprecated 3.1.0
 */
function power_unslash_post_meta_scripts() {
	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Upgrade\Upgrade_DB_2603::unslash_post_meta_scripts()' );
 ...
 */
function power_attributes_site_footer( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\site_footer' );
 ...
 */
function power_attributes_author_box( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\author_box' );
 ...
 */
function power_attributes_comment_content( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\comment_content' );
 ...
 */
function power_attributes_comment_time( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\comment_time' );
 ...
 */
function power_attributes_comment_author_name( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\comment_author_name' );
 ...
 */
function power_attributes_comment_author( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\comment_author' );
 ...
 */
function power_attributes_entry_content( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\entry_content' );

	if ( ! is_main_query() && ! power_is_blog_template() ) {
		return $attributes;
	}
 ...
 */
function power_attributes_entry_title( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\entry_title' );
 ...
 */
function power_attributes_entry_modified_time( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\entry_modified_time' );
 ...
 */
function power_attributes_entry_time( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\entry_time' );
 ...
 */
function power_attributes_entry_author_name( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\entry_author_name' );
 ...
 */
function power_attributes_entry_author( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\entry_author' );
 ...
 */
function power_attributes_entry_image_grid_loop( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\entry_image_grid_loop' );
 ...
 */
function power_attributes_nav( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\attributes_nav' );
 ...
 */
function power_attributes_breadcrumb_link_text_wrap( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\breadcrumb_link_text_wrap' );
 ...
 */
function power_attributes_breadcrumb_link_wrap( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\breadcrumb_link_wrap' );
 ...
 */
function power_attributes_breadcrumb( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\breadcrumb' );
	...
	$yoast_seo_breadcrumbs_enabled    = class_exists( 'WPSEO_Breadcrumbs' ) && power_get_option( 'breadcrumbs-enable', 'wpseo_titles' );
	...
	// Power breadcrumbs require microdata on the wrapper.
 ...
 */
function power_attributes_site_description( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\site_description' );
 ...
 */
function power_attributes_site_title( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\site_title' );
 ...
 */
function power_attributes_header( $attributes ) {

	_deprecated_function( __FUNCTION__, '3.1.0', '\CoreEngine\Power\Functions\Schema\site_header' );
 ...
 *                Return early unmodified if first Power version is higher than 2.0.2.
 */
function power_nav_right( $menu, stdClass $args ) {

	_deprecated_function( __FUNCTION__, '3.0.0' );

	// Only allow if using 2.0.2 or lower.
	if ( power_first_version_compare( '2.0.2', '>' ) ) {
		return $menu;
	}

	if ( 'primary' !== $args->theme_location || ! power_get_option( 'nav_extras' ) ) {
		return $menu;
	}

	switch ( power_get_option( 'nav_extras' ) ) {
		case 'rss':
			$rss   = '<a rel="nofollow" href="' . get_bloginfo( 'rss2_url' ) . '">' . __( 'Posts', 'power' ) . '</a>';
			$rss  .= '<a rel="nofollow" href="' . get_bloginfo( 'comments_rss2_url' ) . '">' . __( 'Comments', 'power' ) . '</a>';
		...
		case 'search':
			...
			break;
		case 'twitter':
			$menu .= sprintf( '<li class="right twitter"><a href="%s">%s</a></li>', esc_url( 'https://twitter.com/' . power_get_option( 'nav_extras_twitter_id' ) ), esc_html( power_get_option( 'nav_extras_twitter_text' ) ) );
			break;
		case 'date':
 ...
 * @deprecated 3.0.0
 */
function power_xhtml_doctype() {

	_deprecated_function( __FUNCTION__, '3.0.0', 'power_html5_doctype' );
 ...
 * XHTML loop.
 *
 * This is called by {@link power_standard_loop()} if the child theme does not support HTML5.
 *
 ...
 *
 *  - `power_before_post`
 *  - `power_before_post_title`
 *  - `power_post_title`
 *  - `power_after_post_title`
 *  - `power_before_post_content`
 *  - `power_post_content`
 *  - `power_after_post_content`
 *  - `power_after_post`
 ...
 */
function power_legacy_loop() {

	_deprecated_function( __FUNCTION__, '3.0.0', 'power_standard_loop' );
 ...
 *
 * Applies only to XHTML child themes, since Power uses default HTML5 comment form where possible.
 *
 * Applies `power_comment_form_args` filter.
 *
 * @since 1.8.0
 * @deprecated 3.0.0
 *
 ...
 */
function power_comment_form_args( array $defaults ) {
...
/**
 * Comment callback for {@link power_default_list_comments()} if HTML5 is not active.
 *
 ...
 */
function power_comment_callback( $comment, array $args, $depth ) {

	_deprecated_function( __FUNCTION__, '3.0.0', 'power_html5_comment_callback' );

	power_html5_comment_callback( $comment, $args, $depth );
 ...
 *
 * Output passes through `power_footer_backtotop_shortcode` filter before returning.
 *
 * @since 1.1.0
 * @deprecated 3.0.0
 *
 ...
 */
function power_footer_backtotop_shortcode( $atts ) {
	...
	$defaults = [
		...
		'href'     => '#wrap',
		'nofollow' => true,
		'text'     => __( 'Return to top of page', 'power' ),
	];

	$atts = shortcode_atts( $defaults, $atts, 'footer_backtotop' );

	return apply_filters( 'power_footer_backtotop_shortcode', '', $atts );
 ...
 * @deprecated 2.10.1
 */
function power_upgraded_notice() {
 ...
 * @deprecated 2.10.1
 */
function power_upgrade_redirect() {
	_deprecated_function( __FUNCTION__, '2.10.1' );
}

/**
 * Deprecated. Replace the default search form with a Power-specific form.
 *
...
/**
 * Deprecated. Power now (as of 2.7.0) uses semantic versioning, and will no longer redirect to different pages based on major/minor version status.
 *
 * Determine if a version string is considered a major release under Power rules.
 *
 * For Power, a release of something like 2.5.0 is a major release version, as is 2.6.0.
 ...
 * release after 2.9.0 will be 3.0.0, and not 2.10.0 - Power does not follow semantic versioning.
 *
 ...
 */
function power_is_major_version( $version ) {
 ...
 */
function power_default_title( $title, $sep = '&raquo;', $seplocation = '' ) {

	_deprecated_function( __FUNCTION__, '2.6.0', 'Power_SEO_Document_Title_Parts' );
 ...
 */
function power_get_additional_image_sizes() {
...
/**
 * Deprecated. A list of Power contributors for the current development cycle.
 *
 * @since 2.0.0
 * @deprecated 2.5.0
 *
 ...
 */
function power_contributors() {

	_deprecated_function( __FUNCTION__, '2.5.0', 'Power_Contributors::find_contributors' );

	$people               = require POWER_CONFIG_DIR . '/contributors.php';
	$power_contributors = new Power_Contributors( $people );

	// The original function didn't contain the logic to shuffle the list, so we use the un-shuffled list here.
	foreach ( $power_contributors->find_by_role( 'contributor' ) as $key => $contributor ) {
		// The collection object currently returns an array of Power_Contributor object, so it can't
...
/**
 * Deprecated. Register the scripts that Power will use.
 *
 * @since 2.0.0
 * @deprecated 2.5.0
 */
function power_register_scripts() {
 ...
 */
function power_load_admin_scripts( $hook_suffix ) {
 ...
 * @deprecated 2.5.0
 */
function power_load_admin_js() {

	_deprecated_function( __FUNCTION__, '2.5.0', 'power_scripts()->enqueue_and_localize_admin_scripts()' );

	power_scripts()->enqueue_and_localize_admin_scripts();
 ...
 *  - link_after     => ''
 *
 * Themes can short-circuit the function early by filtering on `power_pre_nav` or on the string of list items via
 * `power_nav_items`. They can also filter the complete menu markup via `power_nav`. The `$args` (merged with
 ...
 * @return null|string HTML for menu, unless `power_pre_nav` filter returns something truthy.
 */
function power_nav( $args = [] ) {

	_deprecated_function( __FUNCTION__, '2.2.0', 'power_nav_menu' );

	if ( isset( $args['context'] ) ) {
		_deprecated_argument( __FUNCTION__, '1.2', esc_html__( 'The argument, "context", has been replaced with "theme_location" in the $args array.', 'power' ) );
	}
	...
	$defaults = apply_filters( 'power_nav_default_args', $defaults );
	$args     = wp_parse_args( $args, $defaults );

	// Allow child theme to short-circuit this function.
	$pre = apply_filters( 'power_pre_nav', false, $args );
	if ( $pre ) {
		return $pre;
	}
	...
	if ( isset( $args['show_home'] ) && ! empty( $args['show_home'] ) ) {
		...
		if ( in_array( $args['show_home'], [ true, '1', 1 ], true ) ) {
			$text = apply_filters( 'power_nav_home_text', __( 'Home', 'power' ), $args );
		}
		...
		$menu .= power_get_seo_option( 'nofollow_home_link' ) ? power_rel_nofollow( $home ) : $home;
	...
	$menu = apply_filters( 'power_nav_items', $menu, $args );
	...
	$menu = apply_filters( 'power_nav', $menu, $args );
 ...
 */
function power_doctitle_wrap( $title ) {
 ...
 * @param string       $setting Optional. Settings field name. Default is POWER_SETTINGS_FIELD.
 */
function _power_update_settings( $new, $setting = null ) {

	_deprecated_function( __FUNCTION__, '2.1.0', 'power_update_setting' );

	power_update_settings( $new, $setting );
 ...
 *
 * Should now use `power_prev_next_posts_nav()` instead.
 *
 * @since 1.0.0
 * @deprecated 2.0.0
 */
function power_older_newer_posts_nav() {

	_deprecated_function( __FUNCTION__, '2.0.0', 'power_prev_next_posts_nav' );
 ...
 */
function power_show_theme_info_in_head() {

	_deprecated_function( __FUNCTION__, '2.0.0', esc_html__( 'data in style sheet files', 'power' ) );

	if ( ! power_get_option( 'show_info' ) ) {
		return;
	}
...
function g_ent( $text = '' ) { // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedFunctionFound -- Deprecated function name.
	...
	_deprecated_function( __FUNCTION__, '2.0.0', esc_html__( 'decimal or hexidecimal entities', 'power' ) );
...
/**
 * Deprecated. Remove the Power theme files from the Theme Editor, except when Power is the current theme.
 *
 * @since 1.4.0
 * @deprecated 2.0.0
 */
function power_theme_files_to_edit() {
 ...
 */
function power_tweet_linkify( $text ) {
 ...
 * @deprecated 2.0.0
 */
function power_custom_header_admin_style() {
