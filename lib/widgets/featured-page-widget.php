...
/**
 * Power Featured Page widget class.
 *
 * @since 1.0.0
 *
 * @package Power\Widgets
 */
class Power_Featured_Page extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_ops = [
			...
			'description' => __( 'Displays featured page with thumbnails', 'power' ),
		];
		...
		parent::__construct( 'featured-page', __( 'Power - Featured Page', 'power' ), $widget_ops, $control_ops );
		...
		if ( have_posts() ) {
			...
			while ( have_posts() ) {
				...
				if ( ! empty( $instance['show_title'] ) ) {
					 ...
					 * }
					 */
					$title   = apply_filters( 'power_featured_page_title', $title, $instance, $args );
					$heading = power_a11y( 'headings' ) ? 'h4' : 'h2';

					$entry_title = power_markup(
						[
							'open'    => "<{$heading} %s>",
							'close'   => "</{$heading}>",
							'context' => 'entry-title',
				...
				if ( ! empty( $instance['show_content'] ) ) {
					...
					if ( empty( $instance['content_limit'] ) ) {
						...
						the_content( power_a11y_more_link( $instance['more_text'] ) );
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'page_id' ) ); ?>"><?php esc_html_e( 'Page', 'power' ); ?>:</label>
			<?php
			wp_dropdown_pages(
				[
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_title' ) ); ?>"><?php esc_html_e( 'Show Page Title', 'power' ); ?></label>
		</p>
		...
		<p>
			...
			<label for="<?php echo esc_attr( $this->get_field_id( 'show_content' ) ); ?>"><?php esc_html_e( 'Show Page Content', 'power' ); ?></label>
		</p>

		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'content_limit' ) ); ?>"><?php esc_html_e( 'Content Character Limit', 'power' ); ?>:</label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'more_text' ) ); ?>"><?php esc_html_e( 'More Text', 'power' ); ?>:</label>
