 ...
 */
$search_text = apply_filters( 'power_search_text', __( 'Search this website', 'power' ) );
 ...
 */
$search_label = apply_filters( 'power_search_form_label', '' );
 ...
 */
$search_button_text = apply_filters( 'power_search_button_text', esc_attr__( 'Search', 'power' ) );
...
if ( empty( $search_label ) && power_a11y( 'search-form' ) ) {
	$strings['label'] = $search_text;
}

$form = new Power_Search_Form( $strings );
 ...
 */
$searchform = apply_filters( 'power_search_form', $form->get_form(), $search_query_or_text, $strings['submit_value'], $strings['label'] );
